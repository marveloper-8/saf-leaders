        ...
        <div className="home">
            ...
            <div className="mobile">
                ...
                <div className="four">
                    ...
                    <div className="content">
                        <div className="column">
                            <img src="http://safleaders.org/images/sponsors/saf.jpg" className="books" alt="subjects - civic" />
                        </div>
                        <div className="column">
                            <img src="http://safleaders.org/images/sponsors/educational-reform.jpg" className="books" alt="subjects - civic" />
                        </div>
                        <div className="column">
                            <img src="http://safleaders.org/images/sponsors/yali.jpg" className="books" alt="subjects - civic" />
                        </div>
                    </div>
                </div>
            </div>
